...
public class ProdutoController extends GenericController {
    ...
    @ApiOperation(value = "Serviço responsável por obter uma lista de produtos da empresa passado na URL.")
    ...
    @ApiOperation(value = "Rota responsável por remover(exclusão lógica) um produto do sistema.")
    @DeleteMapping("/{id}")
